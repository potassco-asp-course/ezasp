...
\uncover<3->{\alert<3>{
\node[rule, right=of node12, xshift=1.1cm] (rule_seq_1) {\alt<15>{\scode \{a\}.\hspace{8mm}}{$\{a\} \leftarrow$}};
}}

\uncover<4->{\alert<4,9>{
\node[rule, below=of rule_seq_1] (rule_seq_2) {\alt<15>{\scode b :- c.}{$b \leftarrow c$}};
}}

\only<-8>{
\uncover<5-8>{\alert<5>{
\node[rule, below=of rule_seq_2] (rule_seq_3) {$c \leftarrow a$};
}}

\uncover<6-8>{\alert<6>{
\node[rule, below=of rule_seq_3] (rule_seq_4) {$a \leftarrow b$};
}}
} %\only

\only<9->{\alert<9>{
\node[rule, below=of rule_seq_2, yshift=7mm] (rule_seq_3) {\alt<15>{\scode c :- a.}{$c \leftarrow a$}};
\node[rule, below=of rule_seq_3, yshift=7mm] (rule_seq_4) {\alt<15>{\scode a :- b.}{$a \leftarrow b$}};
}}
