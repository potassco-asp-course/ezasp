...
% ----------------------------------------------------------------------
\begin{frame}<1-15,21->{With variables}

\vspace{-1.08cm}
%
{\small 
\begin{semiverbatim}
\alertbf{8,9,13,15}{{\alertbf{6,7}{\hspace{2mm}{\alertbf{5}{n}(\alertbf{2,4}{1})}}}}\alertbf{8,9,15}{.} \newline
\alertbf{8,10,13,15}{\{\alertbf{6,7}{{\alertbf{5}{{a}}(\alertbf{3,4}{{X}})}}\}}\alertbf{8,10,15}{\myleftarrow}\alertbf{6,7,8,10,14,15}{{\alertbf{5}{{ n}}(\alertbf{3,4}{{X}})}}\alertbf{8,10,15}{.}\newline
\alertbf{6,7,8,11,13,15}{\hspace{2mm}{\alertbf{5}{{b}}(\alertbf{3,4}{{X}})}}\alertbf{8,11,15}{\hspace{2.2mm}\myleftarrow}\alertbf{6,7,8,11,14,15}{{\alertbf{5}{{ a}}(\alertbf{3,4}{{X}})}}\alertbf{8,11,15}{.}\newline
\alertbf{8,12,15}{\myleftarrow}\alertbf{6,7,8,12,14,15}{{\alertbf{5}{{ n}}(\alertbf{3,4}{{X}})}}\alertbf{8,12,14,15}{,}\alertbf{7,8,12,14,15}{ \myneg}\alertbf{6,7,8,12,14,15}{{\alertbf{5}{{ b}}(\alertbf{3,4}{{X}})}}\alertbf{8,12,15}{.}\newline
\end{semiverbatim}}%
