...
[
  ...
  smallfontsize/.style={font={\footnotesize}},
...
\alt<2>{
  \node[smodel, below right=of node12, small, xshift=0mm] (node23) {a b} edge [cycle_arrow] (node12);
}{\alert<3-4>{
  \node[smodel, below right=of node12, small, xshift=0mm, align=left, smallfontsize] (node23) 
    {\alt<3>{a b \\[-1mm] c \phantom{d}}
            {a b \\[-1mm] c d}}
...
%
\alert<6-7>{\only<5-7>{
\node[smodel, below right=of  node22, xshift=0mm, small, align=left, movedown, smallfontsize] (node33x) 
  {a b \\[-1mm] \alt<5>{\phantom{c}}{c} \alt<5-6>{\phantom{d}}{d}}
...
%
\alert<8>{
  \node[smodel, below=of node23, xshift=0mm, small, align=left, movedown, smallfontsize] (node33) {a b \\[-1mm] c d}     edge [cycle_arrow] (node23);
}
} % uncover
%
\alert<6-7>{
\node[smodel, below right=of node23, xshift=17mm, small, align=left, movedown, smallfontsize] (node34) 
  {a b e \alt<5>{\phantom{f}}{f} \\[-1mm] c d \alt<5-6>{\phantom{g}}{g}} 
...
\only<9-11>{\alert<10-11>{
  \node[smodel, below right=of  node32, small, align=left, movedown, smallfontsize, xshift=-2mm] (node43)
    {a b \\[-1mm] \alt<9>{\phantom{c}}{c} \alt<9-10>{\phantom{d}}{d}}
    edge [cycle_arrow] (node32);
}}
%
\alert<12>{
\node[smodel, below=of  node33, small, align=left, movedown, smallfontsize] (node44) {a b \\[-1mm] c d}     edge [cycle_arrow] (node33);
}
%
\only<9-11>{\alert<10-11>{
  \node[smodel, below right=of node33, small, align=left, movedown, smallfontsize, xshift=2mm] (node45) 
    {a b e \alt<9>{\phantom{f}}{f} \\[-1mm] c d \alt<9-10>{\phantom{g}}{g}} 
    edge [cycle_arrow] (node33);
}}
%
\alert<12>{
\node[smodel, below=of node34, small, align=left, movedown, smallfontsize] (node46) {a b e f \\[-1mm] c d g} edge [cycle_arrow] (node34);
}
%
