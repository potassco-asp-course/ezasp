...
\alt<17->{
\node[smodel, below right=of xnode12, small, yshift=0.35mm, xshift=2mm] (node23) {a c b} edge [cycle_arrow] (xnode12);
}{
...
\node[rule, below=of rule_seq_2, yshift=7mm] (rule_seq_3) {\scode \hspace{2.5mm}\phantom{\{}c\phantom{\}} :- a.};
\node[rule, below=of rule_seq_2, yshift=7mm] (rule_seq_3) {\scode \hspace{2.5mm}\phantom{\{}d\phantom{\}} :- c.};
...
\node[align=center, smodel, small] at (6.95,0.325) {a c}; %   edge [cycle_arrow] (node33);
\end{tikzpicture}
}
