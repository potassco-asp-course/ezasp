...
\alt<15-16>{\alert<15>{
  ...
  \node[smodel, below left=of  node12, small, xshift=0mm] (node22) {a}     edge [arrow] (node12);
}}{
...
\alt<2>{
  ...
  \alt<15-16>{\alert<15>{
    ...
    \draw[cycle_arrow,->] (node12) -- (node23);
  }
}}
}} % \alert<2> \visible<2->

% line 3
\visible<5-14>{\alert<5>{
%
\uncover<5-12,14>{
...
% line 2! 
\visible<15-16>{\alert<15>{
  \node[smodel, right=of node23, small, align=left, yshift=0mm, xshift=10mm, smallfontsize] (node24) 
    {a\myspace{}b\myspace{}e\myspace{}f\\[-1mm]c\myspace{}d\myspace{}g}
    edge [arrow] (node12);
}}

% line 4
\visible<9-14>{\uncover<9-12,14>{\alert<9>{
...
\node[any] (ok4) at ($ (node24.south east) + (2.8mm,-0.5mm) $) {\OK};
}
