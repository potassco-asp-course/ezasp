...
%\uncover<10->{\alert<10>{
\alt<21-22>{\alert<21>{
  \node[smodel, below=of  xnode11]                         (node21) {}    edge [arrow] (xnode11);
  \node[smodel, below=of  xnode12, small, xshift=0mm]      (node22) {a}   edge [arrow] (xnode12);
  \node[smodel, below right=of xnode12, small, yshift=0.35mm, xshift=3mm] (node23) {a c b} edge [arrow] (xnode12);
  }}{
...
\alt<18->{\alert<18-20>{
    ...
    \node[smodel, below right=of node23, small, xshift=9mm] (node34) {a c b} edge [cycle_arrow] (node23);
    }
}}
{\alert<11>{
\node[smodel, below=of node21]                          (node31) {}      edge [cycle_arrow] (node21);
