...
% ----------------------------------------------------------------------
\begin{frame}<1-5,20-22>{\only<20->{\alert{Easy }}\alt<22>{ASP}{Answer Set Programming}}
\begin{itemize}
%
\alt<1-19>
...
\visible<21->{
\item 
Easy way to \alert<21>{understand} logic programs and their answer sets
\item 
Easy recommendation on how to \alert<21>{write} logic programs
}%\visible
%
\end{itemize}
\end{frame}
