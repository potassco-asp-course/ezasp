...
\node[rule, right=of node12, xshift=8mm] (rule1) 
  {\alt<11>{\scode \{a\}.}{$\{a\}\leftarrow \phantom{a}$}};
}
}
...
\uncover<4->{
\alert<4,7>{
\node[rule, below=of rule1] (rule2) {\alt<11>{\scode b :- a.}{$\phantom{\{\}}b\leftarrow a$}}; %{$\phantom{\{\}}b\leftarrow a$};
...
\uncover<4->{
\alert<4,8>{
\node[rule, below=of rule2] (rule3) {\alt<11>{\scode :- not b.}{$\phantom{{b}\hspace{3.5mm}}\leftarrow \naf{b}$}};
}
}
