...
% Example
% ----------------------------------------------------------------------
\begin{frame}<1-10>[label=ezaspexample1]{Example}
%
$
P
=
...
\node[rule, right=of node12, xshift=9mm] (rule1) 
  {\alt<10>{\scode \ \ \{a\}.\phantom{b :- }}{$\{a\}\leftarrow \phantom{a}$}};
}}
...
\node[rule, below=of rule1] (rule2) 
  {\alt<10>{\scode \ \ b :- a.\phantom{nt}}{$\phantom{\{\}}b\leftarrow a$}}; %{$\phantom{\{\}}b\leftarrow a$};
}}
...
\node[rule, below=of rule2] (rule3) 
  {\alt<10>{\scode \ \ :- not b.}{$\phantom{{b}\hspace{7.5mm}}\leftarrow \neg b$}};
}}
