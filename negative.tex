...
{\node[rule, below=of rule_seq_3, yshift=8mm] (rule_seq_4) {$\alt<5>{\alert<5>{\{a\}}}{a} \leftarrow \alt<2-5>{\alert<2->{\neg b}}{b}$};}
...
\draw[very thick, dotted, rounded corners] 
  ($ (rule_seq_2.north west) + (2mm,1mm) $) rectangle ($ (rule_seq_4.south east) + (-2mm,-1mm) $);
}}{ % non recursive
\draw[very thick, dotted, rounded corners] 
  ($ (rule_seq_2.north west) + (3mm,1mm) $) rectangle ($ (rule_seq_4.south east) + (-3mm,-1mm) $);
}
