...
\\
\begin{tabular}{r@{\ }l}
\alertbf{2,4}{\texttt{road(a,b)}} & \alertbf{2,5}{\texttt{road(b,c)}}\\
\alertbf{2,6}{\texttt{road(c,d)}} & \alertbf{2}{\texttt{road(d,a)}}\\
\visible<3->{
\alertbf{3-4}{\texttt{visit(a)}} \visible<4->{& \alertbf{4-5,8}{\texttt{visit(b)}}\\
\visible<5->{
\alertbf{5-6,8}{\texttt{visit(c)}} \visible<6->{& \alertbf{6,8}{\texttt{visit(d)}}
}}}}
\end{tabular}
};
