...
\alertbf{3}{visit(Y) :- road(X,Y), start(X).}

\alertbf{4-8}{visit(Y) :- road(X,Y), visit(X).}
\end{semiverbatim}
...
\alertbf{2-3}{\texttt{start(a)}}
\\
\begin{tabular}{r@{\ }l}
\alertbf{2-3}{\texttt{road(a,b)}} & \alertbf{2,4}{\texttt{road(b,c)}}\\
\alertbf{2,5}{\texttt{road(c,d)}} & \alertbf{2,6}{\texttt{road(d,a)}}\\
\visible<3->{
\alertbf{3-4}{\texttt{visit(b)}} \visible<4->{& \alertbf{4-5,8}{\texttt{visit(c)}}\\
\visible<5->{
\alertbf{5-6,8}{\texttt{visit(d)}} \visible<6->{& \alertbf{6,8}{\texttt{visit(a)}}
}}}}
\end{tabular}
};
