...
\alert<3>{visit(Y) :- road(X,Y), start(X).}

\alert<4-8>{visit(Y) :- road(X,Y), visit(X).}
\end{semiverbatim}
...
\\
\begin{tabular}{r@{\ }l}
\alert<2-3>{\texttt{road(a,b)}} & \alert<2,4>{\texttt{road(b,c)}}\\
\alert<2,5>{\texttt{road(c,d)}} & \alert<2,6>{\texttt{road(d,a)}}\\
\visible<3->{
\alert<3-4>{\texttt{visit(b)}} \visible<4->{& \alert<4-5,8>{\texttt{visit(c)}}\\
\visible<5->{
\alert<5-6,8>{\texttt{visit(d)}} \visible<6->{& \alert<6,8>{\texttt{visit(a)}}
}}}}
\end{tabular}
};
