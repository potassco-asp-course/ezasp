...
\lstinputlisting[basicstyle=\small\ttfamily]{../ezasp/tampere/cities.lp}
\end{frame}
% ----------------------------------------------------------------------
\begin{frame}[fragile]{Traveling salesperson}{Problem encoding, \texttt{tsp.lp}}
\lstinputlisting[basicstyle=\small\ttfamily]{../ezasp/tampere/tsp-core.lp}
%
\only<2>{\lstinputlisting[basicstyle=\small\ttfamily,linerange=3]{../ezasp/tampere/tsp-weak-constraint.lp}}
%\only<3>{\lstinputlisting[basicstyle=\small\ttfamily,linerange=3]{tsp-minimize.lp}}
\end{frame}
% ----------------------------------------------------------------------
